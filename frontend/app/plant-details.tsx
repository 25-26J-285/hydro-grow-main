      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.toggleContainer}>
          <TouchableOpacity
            style={[
              styles.toggleButton,
              activeTab === 'plant' && styles.toggleButtonActive,
            ]}
            onPress={() => setActiveTab('plant')}
          >
            <Text
              style={[
                styles.toggleText,
                activeTab === 'plant' && styles.toggleTextActive,
              ]}
            >
              Plant
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.toggleButton,
              activeTab === 'disease' && styles.toggleButtonActive,
            ]}
            onPress={() => setActiveTab('disease')}
          >
            <Text
              style={[
                styles.toggleText,
                activeTab === 'disease' && styles.toggleTextActive,
              ]}
            >
              Disease
            </Text>
