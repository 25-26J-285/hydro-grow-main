...
export default function CO2GrassDetails() {
        ...
        <>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.growthInfoRow}>
                    ...
                    <View>
                        <Text style={styles.stageName}>Seed</Text>
            ...
            <View style={[styles.card, styles.alertCard]}>
                <View style={styles.alertContent}>
                    ...
                    <View>
                        <Text style={styles.alertTitle}>Seed Stage Detection Alert</Text>
                        <Text style={styles.alertMessage}>Seed stage detected – 78% confidence</Text>
                    </View>
                </View>
            </View>
        </>
